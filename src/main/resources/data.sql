...
INSERT INTO AK_CHAT_LINE(ID, CHAT_USER_ID, CONTENT)
VALUES (1, 1, 'Message 1 from user 1 to chat 1');

INSERT INTO AK_CHAT_LINE(ID, CHAT_USER_ID, CONTENT)
VALUES (2, 1, 'Message 2 from user 1 to chat 1');

INSERT INTO AK_CHAT_LINE(ID, CHAT_USER_ID, CONTENT)
VALUES (3, 2, 'Message 1 from user 2 to chat 1');
