...
VALUES ('spring-security-oauth2-read-client', 'resource-server-rest-api',
        ...
        'read', 'password,authorization_code,refresh_token,implicit,student_card', 'USER', 10800, 2592000);
...
VALUES ('spring-security-oauth2-read-write-client', 'resource-server-rest-api',
        ...
        'read,write', 'password,authorization_code,refresh_token,implicit,student_card', 'USER', 10800, 2592000);
