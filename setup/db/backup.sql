...
CREATE TABLE `AK_CREDIT_LOG` (
  ...
  `CREDIT_OPERATION` int(1) NOT NULL,
...
CREATE TABLE `AK_USER` (
  ...
  CONSTRAINT `USER_POSITION_ID_FK` FOREIGN KEY (`POSITION_ID`) REFERENCES `AK_POSITION` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `USER_PUSH_ID_FK` FOREIGN KEY (`PUSH_ID`) REFERENCES `AK_PUSH` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2019-12-22 19:20:29
